...
//    using AlyaBackend;
//
//    var sccParentObject = SccParentObject.FromJson(jsonString);
//    var sccSearchObject = SccSearchObject.FromJson(jsonString);
//    var sccStreamObject = SccStreamObject.FromJson(jsonString);
